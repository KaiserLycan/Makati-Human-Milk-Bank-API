...
jest.mock('../db/db.ts', () => ({
    ...
    prisma: {
        ...
        raw_milk: { findMany: (...args) => mockRawMilkFindMany(...args), update: (...args) => mockRawMilkUpdate(...args) },
        pool_milk: { findMany: (...args) => mockPoolMilkFindMany(...args), update: (...args) => mockPoolMilkUpdate(...args) },
        pasteurized_milk: { findMany: (...args) => mockPasteurizedMilkFindMany(...args), update: (...args) => mockPasteurizedMilkUpdate(...args) },

...
describe("Beneficiary API Unit Tests", () => {
    describe("GET /", () => {
        it("should return a list of beneficiaries", async () => {
            ...
            const res = await request(app).get("/").set("Cookie", ["access_token=valid_token"]);
    ...
    describe("GET /:bid", () => {
        it("should return a single beneficiary", async () => {
            ...
            const res = await request(app).get("/1").set("Cookie", ["access_token=valid_token"]);
    ...
    describe("POST /public-register", () => {
        it("should register a new beneficiary publicly", async () => {
            ...
            const res = await request(app).post("/public-register").send({ application });
    ...
    describe("PATCH /:bid", () => {
        ...
        it("should approve beneficiary and send approval email", async () => {
            ...
            expect(mockSendApproval).toHaveBeenCalledWith(
                { name: updatedBeneficiary.name, email: updatedBeneficiary.caregiver_email },
                "beneficiary",
            );
        });
    ...
    describe("DELETE /:bid", () => {
        it("should delete a beneficiary", async () => {
            ...
            const res = await request(app).delete("/1").set("Cookie", ["access_token=valid_token"]);

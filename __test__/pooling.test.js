...
// C. Mock Validate Middleware (Prevent Zod/Joi crashes during tests)
jest.mock("../utils/validate.util.js", () => ({
    __esModule: true,
    default: () => (req, res, next) => {
        // Simulate a 400 error if we pass bad data in Test 1
        if (req.body.raw_milk_ctns && req.body.raw_milk_ctns.includes("bad")) {
